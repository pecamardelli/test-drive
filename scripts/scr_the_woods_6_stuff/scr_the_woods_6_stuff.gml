...
function scr_the_woods_6_stuff() {
...
#region	TRACK ADDONS (BUSHES, TREES, ELECTRIC POLES, SIGNS, GOAL LINE ETC)
	...
	ds_list_add(curves_right, 0.1260, 0.1434, 0.1625, 0.1794, 0.2037, 0.3710, 0.3720, 0.4829, 0.4980, 0.4990, 0.5134, 0.5240, 0.5250, 0.7880, 0.7890, 0.7900, 0.8100, 0.8110);
	// Curves to the left
	var curves_left		= ds_list_create();
	ds_list_add(curves_left, 0.0829, 0.0920, 0.2295, 0.2600, 0.4960, 0.6190, 0.6200, 0.6210, 0.6387, 0.9050, 0.9060);
	...
	var addons_number		= irandom_range(irandom_range(1,12), irandom_range(12,30));
	...
	scr_populate_draw_stuff(irandom_range(4000,6000),120,180,irandom_range(30,50),curves_left,curves_right);
