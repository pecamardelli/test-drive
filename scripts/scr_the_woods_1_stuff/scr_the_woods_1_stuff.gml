...
function scr_the_woods_1_stuff() {
...
#region	TRACK ADDONS (BUSHES, TREES, ELECTRIC POLES, SIGNS, GOAL LINE ETC)
	...
	ds_list_add(curves_right, 0.15, 0.17, 0.24, 0.26, 0.28, 0.30, 0.31, 0.37, 0.50, 0.60, 0.71, 0.73, 0.82, 0.84, 0.85, 0.86, 0.90);
	// Curves to the left
	var curves_left		= ds_list_create();
	ds_list_add(curves_left, 0.045, 0.13, 0.20, 0.34, 0.36, 0.39, 0.42, 0.45, 0.53, 0.57, 0.67, 0.70, 0.75, 0.81, 0.87, 0.91, 0.93);
	...
	scr_populate_draw_stuff(irandom_range(5000,6000),180,150,irandom_range(13,31),curves_left,curves_right);
